...
<div class="contact_section layout_padding">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h1 class="contact_text">개인정보 입력</h1>
        <div class="mail_sectin">
          <form action="test" method="post">
            <input id="name" type="text" class="email-bt" placeholder="name" name="name">
            <input id="hight" type="number" class="email-bt" placeholder="height" name="height">
            <input id="weight" type="number" class="email-bt" placeholder="weight" name="weight">
            <input id="age" type="number" class="email-bt" placeholder="age" name="age">
            <div>
              <button type="submit" class="read_bt1" onclick="location.href='./test'">SEND</button>
            </div>
          </form>
        </div>
      </div>
      <div class="col-md-6">
        <div class="image_9"><img src="../../images/gang.jpeg"></div>
      </div>
    </div>
  </div>
</div>
